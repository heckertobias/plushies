// Node.js-only startup work, loaded from instrumentation.ts behind the NEXT_RUNTIME check. Kept in
// its own module so the edge build of instrumentation.ts never reaches lib/db / lib/push.
